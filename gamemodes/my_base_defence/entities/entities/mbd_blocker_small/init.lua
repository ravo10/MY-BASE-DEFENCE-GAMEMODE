...
function ENT:Initialize()
	...
	self:SetModel("models/props_phx/construct/metal_plate1x2.mdl") -- models/props_phx/construct/metal_plate1x2.mdl, models/props_phx/construct/metal_plate2x2.mdl, models/props_phx/construct/metal_plate4x4.mdl
	--
